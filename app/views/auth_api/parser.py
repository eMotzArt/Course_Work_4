...
register_user_parser.add_argument('email', type=str, help='User name', nullable=False, required=True)
register_user_parser.add_argument('password', type=str, help='User password', nullable=False, required=True)
